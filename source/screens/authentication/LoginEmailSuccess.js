...
import { View, Image, StyleSheet, Dimensions, ScrollView, Text, TouchableOpacity, TextInput, ImageBackground, Alert } from 'react-native';
        ...
        <View style={styles.container}>
            ...
            <View style={{ marginTop: 60, alignSelf: 'center' }}>
                ...
                <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                    ...
                    <Text style={{ color: '#FFFFFF',fontSize:24,fontFamily:'Gilroy',fontWeight:700 }}>Check your email</Text>
                   
                    <View style={{width:width-38,marginTop:10}}>
                    
                     <Text style={{ fontFamily:'Gilroy',color: '#FFFFFF',textAlign:'center',fontSize:16,fontWeight:600 }}>To confirm your email address, please tap the button in the email we sent to {emailEncraptionFormat(props?.route?.params?.email)}</Text>

                    </View>

                    {<AuthButton type={2} title={'Or Manually Enter OTP'} isArrow={false} />}
